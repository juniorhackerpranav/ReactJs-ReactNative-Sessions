...
export default function Products_Static() {
    const categories = [
        { id: 'all', name: 'All Products', active: true },
        { id: 'audio', name: 'Audio & Headphones', active: false },
        { id: 'wearables', name: 'Smart Wearables', active: false },
        { id: 'computing', name: 'Computing & Tech', active: false },
        { id: 'photography', name: 'Cameras & Drones', active: false },
    ];
                    ...
                    <div className="flex-1 max-w-md hidden sm:block">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-100/70 border border-slate-200 rounded-xl text-sm placeholder-slate-400 focus:outline-none transition-all"
                            />
                        </div>
                    </div>

                    <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600 font-medium text-xs">
                            JD
                        </div>
                    </div>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-8 no-scrollbar">
                    {categories.map((cat) => (
                        <button
                            key={cat.id}
                            className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-medium whitespace-nowrap transition-all shadow-xs ${cat.active
                    ...
                    {products.map((product) => (
                        ...
                        >
                            ...
                            <div className="relative aspect-[4/3] bg-slate-100 overflow-hidden">
                                ...
                                <button
                                    className="absolute top-3 right-3 w-8 h-8 rounded-xl bg-white/90 backdrop-blur-xs border border-slate-200/50 flex items-center justify-center text-slate-400 hover:text-rose-500 shadow-xs transition-colors"
                            ...
                            <div className="p-5 flex flex-col flex-1 justify-between">
                                ...
                                <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between">
                                    ...
                                    <button
                                        className="px-4 py-2 bg-slate-900 hover:bg-indigo-600 text-white text-xs font-semibold rounded-xl shadow-xs transition-colors"
                                    >
                                        View Details
                                    </button>
                                </div>
